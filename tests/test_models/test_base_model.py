...
class TestBase(unittest.TestCase):
    ...
    def test_id_type(self):
        """Checks type of the id is string"""
        self.assertEqual("<class 'str'>", str(type(self.my_model.id)))

    def test_ids_differ(self):
        """Checks ids between two instances are different"""
        new_model = BaseModel()
    ...
    def test_kwargs_instantiation(self):
        """Test that an instance is created using key value pair"""
    ...
    def test_compare_dict(self):
        """Test new_model's and my_model's dictionary values"""
        my_model_dict = self.my_model.to_dict()
        new_model = BaseModel(**my_model_dict)
    ...
    def test_instance_diff(self):
        """Test that the my_model and new_model are not the same instance"""
        my_model_dict = self.my_model.to_dict()
        new_model = BaseModel(my_model_dict)
